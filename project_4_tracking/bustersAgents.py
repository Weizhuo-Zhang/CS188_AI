...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for action in legal:
            ...
            if min > self.distancer.getDistance(succesorPosition, ghost_position):
                min = self.distancer.getDistance(succesorPosition, ghost_position)
                best_action = action
        return best_action
